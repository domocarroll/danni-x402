...
- [[Intellectual Property]] - SUBFRACTURE IP lineage, the moat
- [[The Canon]] - Ogilvy + Fallon/Senn + Holt: three-layer strategic mind
- [[SUBFRAC.OS Modules]] - Danni's brain architecture (/strategy, /creative, /synthesize, /validate)
...
- [[ElevenLabs Voice]] - Conversational voice interface for Danni
...
- [[Build Sequence]] - Temporal ordering with checkpoints (~47 hours)
...
## Meta (Bridge Notes)
- [[Decision Log]] - Every decision + rationale + rejected alternatives
- [[Interface Contracts]] - Exact API boundaries between parallel teams
